...
module BaseUI {
	...
	export class UIMapBuildingBase extends fairygui.GComponent {
		...
		public static URL:string = "ui://yaux2xpohzsg2m";

		public static createInstance():UIMapBuildingBase {
			return <UIMapBuildingBase>(fairygui.UIPackage.createObject("BaseUI", "MapBuildingBase"));
		}
